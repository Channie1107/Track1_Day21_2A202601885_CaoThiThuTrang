...
├── deliverables/              # 7 file QUYẾT ĐỊNH — viết bằng ngôn ngữ PM
...
- [ ] `deliverables/` đủ 7 file, đúng tên; file nào cũng có phần **quyết định + vì sao**
...
- [ ] Số liệu trong deliverables khớp với data trong evidence/ (kiểm chứng được)
- [ ] Verdict có đủ 5 phần report và một quyết định rõ ràng
- [ ] `ai-support-log.md` là của chính người nộp

## Gợi ý

- Mỗi file trong `deliverables/` đã có sẵn khung câu hỏi dẫn — trả lời ngắn, dẫn chứng
