...
- Với từng tiêu chí trong `rubric-v1.md`: kiểm tra bằng **code** (deterministic), **LLM
...
- Judge prompt của bạn (`judge_prompt.md`) chấm tiêu chí nào? Nhiệt độ, model judge là
